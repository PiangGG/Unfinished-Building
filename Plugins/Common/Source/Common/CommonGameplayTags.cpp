...
namespace CommonGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Cheat_GodMode, "Cheat.GodMode", "GodMode cheat is active on the owner.");//GodMode欺骗在所有者上处于活动状态。
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Cheat_UnlimitedHealth, "Cheat.UnlimitedHealth", "UnlimitedHealth cheat is active on the owner.");//UnlimitedHealth欺骗在所有者上处于活动状态。
