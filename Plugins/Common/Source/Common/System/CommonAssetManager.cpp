...
UCommonAssetManager& UCommonAssetManager::Get()
{
	...
	UE_LOG(LogCommon, Fatal, TEXT("Invalid AssetManagerClassName in DefaultEngine.ini.  It must be set to LyraAssetManager!"));

	// Fatal error above prevents this from being called.
	return *NewObject<UCommonAssetManager>();
}

const UCommonGameData& UCommonAssetManager::GetGameData()
{
	return GetOrLoadTypedGameData<UCommonGameData>(CommonGameDataPath);
}
...
UPrimaryDataAsset* UCommonAssetManager::LoadGameDataOfClass(TSubclassOf<UPrimaryDataAsset> DataClass,
