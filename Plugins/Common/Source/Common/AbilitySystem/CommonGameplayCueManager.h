...
#include "CommonGameplayCueManager.generated.h"

/**
 * 
 */
UCLASS()
class COMMON_API UCommonGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()
public:
	UCommonGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UCommonGameplayCueManager* Get();
