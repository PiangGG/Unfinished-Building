...
/**
 * FCommonAbilitySet_GameplayAbility
 *
...
/**
 * FCommonAbilitySet_GameplayEffect
 *
...
/**
 * FCommonAbilitySet_AttributeSet
 *
...
/**
 * FCommonAbilitySet_GrantedHandles
 *
...
public:
	...
	void TakeFromAbilitySystem(UCommonAbilitySystemComponent* ASC);
...
class COMMON_API UCommonAbilitySet : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	void GiveToAbilitySystem(UCommonAbilitySystemComponent* ASC, FCommonAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject = nullptr) const;
